...
function viewUpdateLan($lan)
{
    ...
    <div class="flex flex-row justify-center w-full ">
        <form action="/lan/update?lan=<?= $lan["name"] ?>" method="POST" enctype="multipart/form-data"
            ...
            <input type="text" id="name" name="name" placeholder="1Vs1 Tic-tac-to" required value="<?= $lan["name"] ?>"
                   class="px-4 py-2 border-2 rounded-md border-blueGray-200 focus:outline-none focus:ring-2 focus:ring-purple-500">

            <label for="description">Description</label>
            <input type="text" id="description" name="description" placeholder="Description courte" value="<?= $lan["description"] ?>"
                   class="px-4 py-2 border-2 rounded-md border-blueGray-200 focus:outline-none focus:ring-2 focus:ring-purple-500">

            <label for="places">Nombre de place</label>
            <input type="number" id="places" name="places" placeholder="Ex : 23" required value="<?= $lan["places"] ?>"
            ...
            <input type="date" id="start" name="start" placeholder="31.05.2021" required value="<?= date("Y-m-d",strtotime($lan["start"])) ?>"
            ...
            <input type="date" id="end" name="end" placeholder="6.06.2021" required value="<?= date("Y-m-d",strtotime($lan["end"])) ?>"
                   class="px-4 py-2 border-2 rounded-md border-blueGray-200 focus:outline-none focus:ring-2 focus:ring-purple-500" min="<?= date("Y-m-d")?>" max="9999-12-31">
