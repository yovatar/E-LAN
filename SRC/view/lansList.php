    ...
    <div class="flex flex-row justify-center w-full px-6 py-3 bg-white rounded-md filter drop-shadow-md">
        <div class="flex flex-col w-full space-y-3">
            <?php foreach ($lans as $lan) { ?>
                <a href="#" class="flex flex-col items-center w-full px-4 py-2 space-y-2 rounded-md bg-blueGray-100 filter drop-shadow-sm md:items-start md:flex-row md:space-x-3 md:space-y-0 hover:bg-purple-200 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:bg-purple-200 hover:text-purple-900">
