...
<div class="flex flex-row justify-center w-full">
    <form action="/authentication/register" method="POST"
        ...
        <input type="text" id="firstName" name="firstName" placeholder="Bob" required
            class="border-2 rounded-md h-11 border-blueGray-200 focus:outline-none focus:ring-2 focus:ring-purple-500">
        <div role="password validation" class="flex flex-col space-y-2" x-data="{valid : null}">
            <label for="password">Mot de passe</label>
            <div role="passwordField" class="relative" x-data="{show : false}">
                <input
                    :class="{'border-blueGray-200':$parent.valid === null,'border-red-500':$parent.valid === false, 'border-green-500': $parent.valid === true}"
                    x-bind:type="show ? 'text' : 'password'" id="password" name="password" required x-ref="iptPassword"
