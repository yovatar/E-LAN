...
?>
    <div class="flex flex-row justify-center w-full">
        <form action="/createTeam" method="POST" enctype="multipart/form-data" class="flex flex-col w-full px-6 py-3 space-y-2 bg-white rounded-md md:w-8/12 filter drop-shadow-md">
            <h1 class="mb-2 text-xl font-medium">Création de Team</h1>
            <div class="flex flex-col-reverse space-y-3 space-y-reverse md:flex-row md:space-x-5 md:space-y-0">
                <div class="flex flex-col justify-between flex-grow space-y-2">
                    ...
                    <div class="flex flex-col w-full place-self-end lg:flex-row lg:items-center lg:space-x-3 lg:space-y-0">
                ...
                <div class="flex flex-col items-center">
                    <div class="relative" x-data="imageSelector">
                        <img src="/public/images/photograph.svg" :src="imageUrl ?? '/public/images/photograph.svg'" alt="Image de profile" class="object-cover w-48 h-48 bg-white rounded-full filter drop-shadow-md" loading="lazy">
