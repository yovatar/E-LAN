...
<body class="flex flex-col justify-between min-h-screen bg-white">
    ...
    <footer class="flex flex-col justify-center p-2">
        <div
            class="flex flex-col justify-center pt-2 font-medium text-gray-700 border-t-2 border-purple-500 lg:flex-row lg:space-x-3">
    ...
    <div role="toast area" x-data="{toasts : []}" @toast.window="toasts.push($event.detail)"
        class="fixed flex flex-col items-end space-y-2 right-2 bottom-4" x-init="$nextTick(() => {
        ...
        <template x-for="(toast,index) in toasts" :key="index">
            <div class="flex flex-row items-center px-3 py-2 space-x-2 rounded-md"
                :class="toast.class ?? 'bg-blue-500 text-white'">
    ...
    <script src="/public/js/alpinev3.js"></script>
</body>
