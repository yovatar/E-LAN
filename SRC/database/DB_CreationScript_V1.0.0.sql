...
-- Schema E-LAN
-- -----------------------------------------------------
DROP SCHEMA IF EXISTS `E-LAN` ;

-- -----------------------------------------------------
-- Schema E-LAN
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `E-LAN` DEFAULT CHARACTER SET utf8 ;
USE `E-LAN` ;

-- -----------------------------------------------------
-- Table `E-LAN`.`Roles`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `E-LAN`.`Roles` ;

CREATE TABLE IF NOT EXISTS `E-LAN`.`Roles` (
...
-- Table `E-LAN`.`Users`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `E-LAN`.`Users` ;

CREATE TABLE IF NOT EXISTS `E-LAN`.`Users` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
-- Table `E-LAN`.`Stats`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `E-LAN`.`Stats` ;

CREATE TABLE IF NOT EXISTS `E-LAN`.`Stats` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
-- Table `E-LAN`.`Lans`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `E-LAN`.`Lans` ;

CREATE TABLE IF NOT EXISTS `E-LAN`.`Lans` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `name` VARCHAR(45) NOT NULL,
...
-- -----------------------------------------------------
-- Table `E-LAN`.`Locations`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `E-LAN`.`Locations` ;

CREATE TABLE IF NOT EXISTS `E-LAN`.`Locations` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `Name` VARCHAR(45) NOT NULL,
...
-- Table `E-LAN`.`Events`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `E-LAN`.`Events` ;

CREATE TABLE IF NOT EXISTS `E-LAN`.`Events` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `name` VARCHAR(45) NOT NULL,
...
-- Table `E-LAN`.`Teams`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `E-LAN`.`Teams` ;

CREATE TABLE IF NOT EXISTS `E-LAN`.`Teams` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `name` VARCHAR(45) NOT NULL,
...
-- -----------------------------------------------------
-- Table `E-LAN`.`Tournaments`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `E-LAN`.`Tournaments` ;

CREATE TABLE IF NOT EXISTS `E-LAN`.`Tournaments` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
-- Table `E-LAN`.`Matches`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `E-LAN`.`Matches` ;

CREATE TABLE IF NOT EXISTS `E-LAN`.`Matches` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `start` DATETIME NOT NULL,
  `end` DATETIME NOT NULL,
  ...
  CONSTRAINT `fk_Matches_Tournaments1`
    ...
    REFERENCES `E-LAN`.`Tournaments` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `E-LAN`.`Tournaments_has_Events`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `E-LAN`.`Tournaments_has_Events` ;

CREATE TABLE IF NOT EXISTS `E-LAN`.`Tournaments_has_Events` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `E-LAN`.`Events_has_Lans`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `E-LAN`.`Events_has_Lans` ;

CREATE TABLE IF NOT EXISTS `E-LAN`.`Events_has_Lans` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `Event_id` INT NOT NULL,
  `Lan_id` INT NOT NULL,
...
-- -----------------------------------------------------
-- Table `E-LAN`.`Tournaments_has_Teams`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `E-LAN`.`Tournaments_has_Teams` ;

CREATE TABLE IF NOT EXISTS `E-LAN`.`Tournaments_has_Teams` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `Tournament_id` INT NOT NULL,
...
-- -----------------------------------------------------
-- Table `E-LAN`.`Events_has_Locations`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `E-LAN`.`Events_has_Locations` ;

CREATE TABLE IF NOT EXISTS `E-LAN`.`Events_has_Locations` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `Event_id` INT NOT NULL,
...
-- -----------------------------------------------------
-- Table `E-LAN`.`Events_has_Users`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `E-LAN`.`Events_has_Users` ;

CREATE TABLE IF NOT EXISTS `E-LAN`.`Events_has_Users` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `Event_id` INT NOT NULL,
...
CREATE TABLE IF NOT EXISTS `E-LAN`.`Teams_has_Users` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `Team_id` INT NOT NULL,
  `User_id` INT NOT NULL,
